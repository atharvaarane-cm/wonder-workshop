...
function Toasts(
  ...
  return (
    <Toast.Portal data-slot="toast-portal" {...portalProps}>
      <Toast.Viewport
        className={cn(
          "fixed z-[2147483647] mx-auto flex w-[calc(100%-var(--toast-inset)*2)] max-w-90 [--toast-inset:--spacing(4)] sm:[--toast-inset:--spacing(8)]",
      ...
      <Toast.Viewport className="outline-none" data-slot="toast-viewport-anchored">
        {toasts.map((toast) => {
          ...
          return (
            <Toast.Positioner
              key={toast.id}
              className="z-[2147483647] max-w-[min(--spacing(64),var(--available-width))]"
