...
// Cloud-parity no-op: the local project list is already complete and synchronous,
// so there's nothing to hydrate. Returns the current list so callers can await
// refreshProjects() uniformly across local and cloud modes.
